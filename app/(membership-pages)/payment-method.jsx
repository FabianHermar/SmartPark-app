		...
		<SafeAreaView className='bg-white h-full'>
			...
			<ScrollView>
				<View className='w-full justify-start h-full px-4 pt-10'>
					...
					<View className='py-4'>
						<Text className='text-white font-GilroyBold text-4xl'>Choose Payment Method</Text>
						<Text className='text-neutral-400 font-GilroyRegular pt-2 text-base'>To complete your SmartPark + membership, please select your preferred payment method.</Text>
					</View>
					<View>
						<FormField
							title='Name'
